...
describe('import', () => {
  ...
  it('should import a local .json file', async () => {
    const id = uuid();
    const modulePath = absolute(`${testDirectory}/${id}.json`);
