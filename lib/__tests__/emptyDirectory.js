...
describe('emptyDirectory', () => {
  ...
  it('should have removed all content of the directory', async () => {
    ...
    await emptyDirectory(`${testDirectory}/folder`);
  ...
  it('should return true when done', async () => {
    ...
    const actual = await emptyDirectory(`${testDirectory}/folder`);
  ...
  it('should return false if not a folder', async () => {
    ...
    const actual = await emptyDirectory(`${testDirectory}/foo.txt`);
  ...
  it('with relative paths', async () => {
    ...
    await runInUserland(
      dedent`
        const { emptyDirectory } = await __import('./emptyDirectory.js');
        return await emptyDirectory('./mydir');
      `,
