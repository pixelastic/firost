...
describe('glob', () => {
  ...
  it('should find files with *', async () => {
    ...
    const actual = await current(`${tmpDir}/*.txt`);
  ...
  it('should find directories with *', async () => {
    ...
    const actual = await current(`${tmpDir}/*`);
  ...
  it('should exclude directories if directories: false', async () => {
    ...
    const actual = await current(`${tmpDir}/*`, { directories: false });
  ...
  it('should exclude hidden files if hiddenFiles: false', async () => {
    ...
    const actual = await current(`${tmpDir}/*`, { hiddenFiles: false });
  ...
  it('should return results ordered', async () => {
    ...
    const actual = await current(`${tmpDir}/foo*`);
  ...
  it('should allow several patterns as array', async () => {
    ...
    const actual = await current([`${tmpDir}/*.gif`, `${tmpDir}/*.txt`]);
