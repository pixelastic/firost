...
describe('watch', () => {
  ...
  describe('main', () => {
    ...
    it('should save the watcher in cache', async () => {
      const watcher = await current('pattern', jest.fn());
    ...
    it('should save the watcher with specific name', async () => {
      const watcher = await current('pattern', jest.fn(), 'foo');
