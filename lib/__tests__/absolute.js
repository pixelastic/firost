...
// We do not use _current, as we are testing it from userland, but we need to
// include it for vitest to reload the tests whenever the source is updated
import _current from '../absolute.js';
...
async function getUserlandResults() {
  ...
  const moduleFirostImportFilepath = `${moduleLibFilepath}/import.js`;
