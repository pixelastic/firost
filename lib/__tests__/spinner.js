...
describe('spinner', () => {
  ...
  describe('Stdin handling', () => {
    it('should stop on Ctrl-C', () => {
      mockStdin((stdin) => {
        const progress = spinner(3000);
        progress.tick('step one');
        ...
        expect(actual).toHaveProperty('code', 'FIROST_SPINNER_CTRL_C');
      });
    });
    it('should stop once the spinner is over', () => {
      mockStdin((stdin) => {
        vi.spyOn(stdin, 'pause');
